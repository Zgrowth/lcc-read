export enum Commands {
    "openReaderView" = "vsc-plugin-lcc-reader.command.openReaderView",
    "openLocal" = "vsc-plugin-lcc-reader.command.openLocal",
    "refreshLocal" = "vsc-plugin-lcc-reader.command.refreshLocal",
    ...
    "reparseChapters" = "vsc-plugin-lcc-reader.command.reparseChapters"
};